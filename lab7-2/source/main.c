...
int main(void)
{
	...
	pRead = fopen("C://Users/User/Desktop/lab7-2/credit.txt", "r"); 
	if (NULL == pRead)
	{
		return 0;
	}
	pWrite = fopen("C://Users/User/Desktop/lab7-2/credit_bin.txt", "wb");
	if (NULL == pWrite)
	{
		fclose(pRead);
		return 0;
	...
	system("pause");
	printf("\n讀取二進位資料檔案，並格式化輸出如下 : \n");
	if ((cfPtr = fopen("C://Users/User/Desktop/lab7-2/credit_bin.txt", "rb")) == NULL)
	{
